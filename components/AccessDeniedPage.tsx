    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-950 text-white p-4">
            <div className="text-center max-w-2xl">
                ...
                <Icon name="lock-closed" className="w-16 h-16 text-red-500 mx-auto mb-4" />
                <h1 className="text-4xl font-extrabold mb-4">Access Denied</h1>
                <p className="text-lg text-gray-400">
                    You are attempting to access this service from a restricted location, device, or browser.
                    <br />
