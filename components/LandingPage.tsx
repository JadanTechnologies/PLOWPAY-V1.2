                ...
                <div className="text-center lg:text-left">
                    ...
                    <div className="mt-8 flex justify-center lg:justify-start gap-4">
                        <button onClick={() => onNavigate('signup')} className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold px-6 py-3 rounded-lg hover:from-cyan-600 hover:to-teal-600 transition-transform transform hover:scale-105 shadow-lg shadow-cyan-500/30">
                         ...
                         <button onClick={() => onNavigate('contact')} className="bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold px-6 py-3 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors border border-slate-300 dark:border-slate-700">
                            Request a Demo
                        </button>
                    </div>
                </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="bg-white dark:bg-slate-800/50 p-6 rounded-lg shadow-md border border-slate-200 dark:border-slate-700">
                  <div className="bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900/50 dark:to-teal-900/50 text-cyan-600 dark:text-cyan-400 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {subscriptionPlans.map((plan) => (
                <div key={plan.id} className={`bg-white dark:bg-slate-800/50 p-8 rounded-lg border-2 ${plan.recommended ? 'border-cyan-500' : 'border-slate-200 dark:border-slate-700'} relative flex flex-col shadow-lg`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
                ...
                <ul className="mt-4 space-y-2">
                    <li><a href="#features" className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Features</a></li>
                    <li><a href="#pricing" className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Pricing</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('faq'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">FAQs</a></li>
                </ul>
            </div>
            <div>
                <h4 className="font-semibold text-slate-800 dark:text-white">Company</h4>
                <ul className="mt-4 space-y-2">
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('about'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">About</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('contact'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Contact</a></li>
                </ul>
            </div>
             <div>
                <h4 className="font-semibold text-slate-800 dark:text-white">Resources</h4>
                <ul className="mt-4 space-y-2">
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('blog'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Blog</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('help'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Help Center</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('api'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">API Docs</a></li>
                </ul>
            </div>
             <div>
                <h4 className="font-semibold text-slate-800 dark:text-white">Legal</h4>
                <ul className="mt-4 space-y-2">
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('privacy'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Privacy Policy</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('terms'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Terms of Service</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); onNavigate('refund'); }} className="text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white">Refund Policy</a></li>
                </ul>
            </div>
          </div>
