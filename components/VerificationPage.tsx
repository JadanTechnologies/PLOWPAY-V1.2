            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-slate-800 rounded-2xl shadow-2xl text-center border border-slate-700">
                ...
                {isVerifying ? (
                     <div>
                        ...
                        <p className="text-lg text-slate-300">Account verified successfully!</p>
                        <p className="text-slate-400 mt-2">Redirecting to login in {countdown} seconds...</p>
                    </div>
                ) : (
                    <>
                        <p className="text-slate-400">
                            Thank you for signing up! A verification link has been sent to <strong className="text-cyan-400">{email}</strong>. Please check your inbox to activate your account.
                        </p>
