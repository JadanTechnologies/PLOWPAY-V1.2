    ...
    return (
        <div className="space-y-6">
            <div className="p-6 bg-slate-800 rounded-lg shadow-md">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-slate-400 mt-1">Configure providers for email, SMS, and push notifications.</p>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Email Settings */}
                <div className="bg-slate-800 rounded-lg shadow-md p-6 space-y-4">
                ...
                <div className="bg-slate-800 rounded-lg shadow-md p-6 space-y-4">
                    ...
                    <div className={`space-y-4 ${!formState.sms.twilio.enabled && 'opacity-50'}`}>
                        <div>
                            <label className="block text-sm font-medium text-slate-400">Account SID</label>
                            <input
                                type="text"
                                ...
                                className="mt-1 block w-full bg-slate-700 border border-slate-600 rounded-md py-2 px-3 text-white disabled:bg-slate-700/50"
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-400">API Key</label>
                         ...
                         <div>
                            <label className="block text-sm font-medium text-slate-400">From Number</label>
                            <input
                                type="text"
                ...
                <div className="bg-slate-800 rounded-lg shadow-md p-6 space-y-4 lg:col-span-2">
                    ...
                    <div className="p-4 rounded-lg border border-slate-700">
                        ...
                        <div className={`space-y-4 mt-4 ${!formState.push.firebase.enabled && 'opacity-50'}`}>
                            <div>
                                <label className="block text-sm font-medium text-slate-400">Server Key</label>
                                <input
                                    type="password"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-400">VAPID Key</label>
                                <input
                                    type="text"
                    ...
                    <div className="p-4 rounded-lg border border-slate-700">
                        ...
                        <div className={`space-y-4 mt-4 ${!formState.push.oneSignal.enabled && 'opacity-50'}`}>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-400">REST API Key</label>
                                <input
                                    type="password"
