...
const TenantAuditLogs: React.FC = () => {
    ...
    }, [tenantLogs, searchTerm, dateRange]);
    
    return (
        <div className="p-6 bg-slate-800 rounded-lg shadow-lg border border-slate-700">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-white">Staff Audit Logs</h2>
                    <p className="text-slate-400 mt-1">Track activities performed by your staff members.</p>
                </div>
            </div>
